    ...
    <div className="bg-[#f6f7fb] py-10 px-4 flex justify-center">
      <div className="w-full max-w-[900px]">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#23205b]">
            Privacy Policy
          </h1>
          <p className="text-[#4974a4] text-sm mt-2 max-w-[600px] mx-auto">
        ...
        {[
          ...
          <div key={index}
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="font-semibold text-[#23205b]">
                {item.title}
              </h2>
            </div>
        ...
        <div className="bg-[#eef0ff] p-5 rounded-xl border border-[#d6d9ff]">
          <h2 className="font-semibold text-[#184070] mb-4">
            Contact Information
          </h2>
