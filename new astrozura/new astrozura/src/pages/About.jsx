...
import scope from "../assets/scope.jpeg";
...
import moon from "../assets/moon-and-stars.png";
import moonpic from "../assets/moonpic.jpeg";
...
export default function AboutAstrozura() {
  ...
  return (
    ...
    <div className="w-full">
      ...
      <div
        ...
        style={{ background: "#5e6bcd" }}>
        <div className="flex justify-center mb-4">
          <img src={icon4} className="w-12 h-12" />
        </div>
        <h1 className="text-4xl font-bold mb-3 text-[#f3d38d]">
          About Astrozura
        </h1>
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          <button
            ...
            style={{
              background: activeBtn === "explore" ? "#23205b" : "#fff",
          ...
          <button
            ...
            className="px-6 py-2 rounded-full font-medium transition"
            style={{
              background: activeBtn === "learn" ? "#23205b" : "#fff",
      ...
      {/* ABOUT */}
      <div className="grid md:grid-cols-2 gap-10 px-6 md:px-20 py-16 items-center bg-[#f8f7fb]">
        <div>
          <p className="text-xs text-[#23205b] font-semibold mb-2">
            OUR GENESIS
          </p>

          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#23205b]">
            Illuminating Paths Through Cosmic Wisdom
          </h2>

          <p className="text-[#4974a4] text-sm mb-4">
            Astrozura was created to bridge ancient astrology with modern life.
            Every individual carries a unique cosmic blueprint.
          </p>

          <p className="text-[#4974a4] text-sm mb-6">
          ...
          <div className="flex gap-10">
            <div>
              <h3 className="text-[#184070] font-bold text-xl">15K+</h3>
              <p className="text-xs text-[#4974a4]">Readings Completed</p>
            </div>

            <div>
              <h3 className="text-[#184070] font-bold text-xl">98%</h3>
              <p className="text-xs text-[#4974a4]">Accuracy Rate</p>
            </div>

            <div>
              <h3 className="text-[#184070] font-bold text-xl">24/7</h3>
              <p className="text-xs text-[#4974a4]">Support</p>
            </div>
          </div>
        </div>

        <div>
          <img src={scope} className="rounded-2xl shadow-lg w-full" />
        </div>
      </div>

      {/* PRINCIPLES */}
      <div className="py-16 px-6 md:px-20 text-center bg-[#f8f7fb]">
        <p className="text-xs text-[#d8b14a] font-semibold mb-2">
          MISSION & VALUES
        </p>

        <h2 className="text-2xl md:text-3xl font-bold mb-10 text-[#23205b]">
          The Core Principles That Guide Our Astrology Guidance
        </h2>

        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-[#e9e6f8] p-6 rounded-xl">
            <img src={target} className="w-10 mx-auto mb-3" />
            <h3 className="font-semibold mb-2">Accurate Predictions</h3>
            <p className="text-sm text-[#4974a4]">
              Delivering precise and meaningful astrological insights.
            </p>
          </div>

          <div className="bg-[#e9e6f8] p-6 rounded-xl">
            <img src={handshake} className="w-10 mx-auto mb-3" />
          ...
          <div className="bg-[#e9e6f8] p-6 rounded-xl">
            <img src={fire} className="w-10 mx-auto mb-3" />
      ...
      {/* WHY TRUST */}
      <div className="bg-[#1a1446] text-white py-16 px-6 md:px-20">
  ...
  <div className="grid md:grid-cols-2 gap-10 items-start">
    <div className="space-y-4">
      ...
      <div className="flex items-start gap-3 bg-[#184070] p-4 rounded-xl border border-[#4974a4]">
      ...
      {/* PRIVACY */}
      <div className="flex items-start gap-3 bg-[#184070] p-4 rounded-xl border border-[#4974a4]">
        <img src={moon} className="w-6 h-6 mt-1" />
        <div>
          <p className="text-sm font-semibold">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
      <div className="flex gap-3 items-start">
        <img src={scroll} className="w-5 h-5 mt-1" />
        <div>
      ...
      <div className="flex gap-3 items-start">
        <img src={sun} className="w-5 h-5 mt-1" />
        <div>
      ...
      <div className="flex gap-3 items-start">
        <img src={signpost} className="w-5 h-5 mt-1" />
        <div>
      ...
      <div className="flex gap-3 items-start">
        <img src={group} className="w-5 h-5 mt-1" />
        <div>
      ...
      <div className="bg-[#f8f7fb] py-16 px-6 md:px-20 text-center">
        <p className="text-xs text-[#5e6bcd] mb-2">MEET THE SAGES</p>
        <h2 className="text-2xl md:text-3xl font-bold mb-12 text-[#23205b]">
          The Master Minds Behind Your Celestial Insights
        </h2>
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
          {[ 
            { img: moonpic, name: "Seraphina Moon" },
            { img: girl1, name: "Caelum Thorne" },
            { img: girl2, name: "Lyra Vance" },
            { img: man, name: "Orion Frost" }
          ].map((item, i) => (
            <div key={i} className="bg-white p-6 rounded-xl shadow-sm">
              <img src={item.img} className="w-16 h-16 mx-auto rounded-full mb-3 object-cover" />
              <h3 className="font-semibold">{item.name}</h3>
              <p className="text-xs text-[#d8b14a] mb-2">ASTRO EXPERT</p>
              <p className="text-xs text-[#184070]">
      ...
      <div className="bg-[#f8f7fb] px-6 md:px-20 pb-20">
        <div className="bg-gradient-to-r from-[#184070] to-[#184070] text-white rounded-2xl py-12 text-center">
     ...
     className="px-6 py-2 rounded-full transition"
         style={{
        background: active === "consult" ? "#d8ba4a" : "#fff",
          color: "#000", }}>
        Get Consultation
        </button>
      <button onClick={() => setActive("services")}
       className="px-6 py-2 rounded-full transition"
         style={{
    background: active === "services" ? "#d8ba4a" : "#fff",
    color: "#000",
            }}>
      View Services
          </button>
