...
const PolicyCard = ({ icon, title, children }) => {
  return (
    <div className="bg-white shadow-md rounded-xl p-5 flex gap-4 items-start hover:shadow-lg transition">
      ...
      <div>
        <h3 className="font-semibold text-[#23205b] mb-2">{title}</h3>
        <ul className="text-[#4974a4] text-sm space-y-1">{children}</ul>
      </div>
    </div>
  );
};
      ...
      <div className="bg-[#f9f9f8] min-h-screen py-10 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-[#5e6bcd] mt-2 text-sm md:text-base">
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white shadow-md rounded-xl p-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="font-semibold text-[#4974a4]">
                    Need Further Assistance?
                  </h3>
                  <p className="text-sm text-[#4974a4] flex items-center gap-2 mt-1">
                    <img src={gmail} alt="" className="w-4 h-4" />
                    <a
                      href="mailto:support@astrozura.com"
                      className="text-[#5e6bcd] hover:underline">
              ...
              <button
                ...
                className="w-full md:w-auto bg-[#5e6bcd] text-white px-5 py-2 rounded-full hover:bg-[#184070] transition">
                Contact Support
              </button>
            </div>
          </div>
