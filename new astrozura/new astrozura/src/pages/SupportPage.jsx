...
export default function SupportPage() {
  ...
  return (
    <>
    <div className="bg-[#f9f7f3] min-h-screen px-4 md:px-16 py-10">
      {/* HEADER */}
      <h1 className="text-3xl font-bold text-center text-[#23205b]">
        Support
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        ...
        <div
          ...
          <h3>Email Us</h3>
          <p className="text-sm text-[#5e6bcd]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
        ...
        <div className="md:col-span-2">
          <h2 className="text-xl font-semibold text-[#23205b]">
            Frequently Asked Questions
          </h2>
          <p className="text-sm text-[#5e6bcd] mb-4">
         ...
         <img src={caret}
             className={`w-4 h-4 object-contain transition-transform duration-300 ${
              ...
              {faqIndex === i && (
                <p className="text-sm text-[#5e6bcd] mt-2">{item.a}</p>
              )}
            </div>
          ))}
          {/* FORM */}
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            className="bg-[#d8b14a] text-white px-6 py-2 rounded mt-4 flex items-center gap-2 cursor-pointer hover:opacity-90 transition">
                 Submit Request
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <span className="text-xs text-[#4974a4]">2 GUIDES ONLINE</span>
            </div>
            <button
              onClick={() => alert("Chat Started")}
              className="bg-[#4974a4] text-white w-full py-2 rounded mt-4">
              Start Conversation
            </button>
          </div>
          {/* PRIVACY */}
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <ul className="text-sm text-[#5e6bcd] mt-2">
          ...
          {/* FOLLOW */}
          <div className="bg-[#4974a4] text-white p-6 rounded-xl">
