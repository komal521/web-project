...
import phoneIcon from "../assets/phnicon.png";
...
export default function Contact() {
  return (
    <>
    <div className="bg-[#f8f7f5] min-h-screen py-12 px-4 md:px-16">
      {/* Heading */}
      <div className="text-center mb-12">
        <p className="text-sm text-[#4974a4]">Connect with the Cosmos</p>
      ...
      <div className="grid md:grid-cols-2 gap-10 items-start">
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="border p-3 rounded-lg w-full mt-1 focus:outline-none focus:ring-2 focus:ring-[#4974a4]"
              />
            </div>
            {/* Email */}
            <div>
          ...
          <button
            ...
            className="mt-5 w-full bg-[#4974a4] text-white py-3 rounded-lg flex items-center justify-center gap-2 hover:opacity-90 transition">
            Send Message
        ...
        <div className="space-y-8 max-w-md mx-auto">
          ...
          <div className="text-center">
            <h2 className="text-xl font-semibold text-[#4974a4]">
              Astral Headquarters
            </h2>
            <div className="w-16 h-[2px] bg-[#4974a4] mx-auto mt-2"></div>
          </div>
          ...
          {/* Phone */}
          <div className="flex gap-3 items-start">
            <img src={phoneIcon} className="w-5 h-5 mt-1" />
            <div>
          ...
          {/* Email */}
          <div className="flex gap-3 items-start">
            <img src={emailIcon} className="w-5 h-5 mt-1" />
            <div>
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              {[instagramIcon, twitterIcon, facebookIcon, youtubeIcon].map(
                (icon, i) => (
                  <img
                    key={i}
                    src={icon}
                    className="w-9 h-9 p-2 bg-white rounded-full shadow cursor-pointer hover:scale-110 transition"
                  />
                )
              )}
            </div>
